     ...
     <div>
        <div className="row m-0" style={{padding:'20px'}}>
            ...
            <div className="col-sm-12 col-md-12 col-lg-6  mid-div" style={{marginTop:'20px'}}>
                ...
                <p id='change' style={{fontFamily:'Dosis,sans-serif', fontSize:'22px',textAlign:'center'}}>{this.state.text[this.state.index]}</p> 
                ...
                <i className=" material-icons right" style={{fontSize:'50px'}} onClick={this.handleToggle}>{this.state.isExpanded?'arrow_drop_up':'arrow_drop_down'}</i>
            </div>
        </div>
     </div>
    );
